...
public class Feignclientcontroller {
	...
	@GetMapping(value="/converttousd/{sa}", produces= MediaType.APPLICATION_JSON_VALUE)
	public ResponseEntity<String> converttousd(@PathVariable(name="sa") String number)
	{
		String t=greetingsfeignclient.converttousd(number);
		return new ResponseEntity<String>(t,HttpStatus.OK);
	}
	
	@GetMapping(value="/counverttoyen/{sa}",produces=MediaType.APPLICATION_JSON_VALUE)
	public ResponseEntity<String> convertoyen(@PathVariable(name="sa")String number)
	{
		String t=greetingsfeignclient.convertoyen(number);
		return new  ResponseEntity<String>(t,HttpStatus.OK);
				
	}
	
	@GetMapping(value="convertoeuro/{sa}",produces=MediaType.APPLICATION_JSON_VALUE)
	public ResponseEntity<String> convertoeuro(@PathVariable(name="sa")String number)
	{
		String t=greetingsfeignclient.convertoeuro(number);
		return new ResponseEntity<String>(t,HttpStatus.OK);
	}
